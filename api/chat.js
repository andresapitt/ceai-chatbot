// ShineVR secure backend: Gemini chat proxy (Vercel serverless function)
// =======================================================================
// Vercel automatically turns files in this root-level /api directory into
// serverless functions, so this file is served at  POST /api/chat  with NO
// special configuration and NO custom Root Directory setting.
//
// It holds the Gemini API key in an environment variable, so the key is NEVER
// sent to the browser or committed to GitHub. The static frontend POSTs the
// conversation here; this function adds the key and the system prompt, calls
// Gemini, and returns only the reply text.
//
